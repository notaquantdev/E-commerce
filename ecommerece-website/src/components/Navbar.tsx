    ...
    <div className="flex items-center justify-between py-5 font-medium">
        ...
        <div className='flex items-center gap-6'>
            ...
            <Link to={'/cart'} className='relative'> 
                ...
                <p className='absolute -right-1.25 -bottom-1.25 w-4 text-center leading-4 bg-black text-white rounded-full text-[8px]'>10</p>
            </Link>    

            <img onClick={() => setVisible(true)} src={asset.menu_icon} alt="" className='w-5 cursor-pointer sm:hidden' /> 
        </div>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
            <div className='flex flex-col text-gray-600'>
                <div onClick={() => setVisible(false)} className='flex items-center gap-4 p-3'>
                    <img src={asset.dropdown_icon} className='h-4 rotate-180' alt="" />
                    <p>Back</p>
                </div>
